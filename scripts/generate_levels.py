...
if __name__ == "__main__":
    ...
    generate_game_set((6, 6), 50, 50,   "6x6_1-9_levels.json", 1, 9)
    generate_game_set((6, 6), 50, 100,  "6x6_-1-9_levels.json", -1, 9)
    generate_game_set((6, 6), 100, 150, "6x6_-1-12_levels.json", -1, 12)
    generate_game_set((6, 6), 300, 250, "6x6_-1-19_levels.json", -1, 19)
    generate_game_set((6, 6), 250, 550, "6x6_-9-19_levels.json", -9, 19)
    generate_game_set((6, 6), 200, 800, "6x6_-19-19_levels.json", -19, 19)
